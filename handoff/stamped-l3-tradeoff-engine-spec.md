...
> **Authority:** [ADR-024](../decisions/ADR-024-holistic-plant-decisions.md) · [L3 intelligence core](../technical/layers/L3-intelligence-core.md) · contracts: [`production-order.json`](../contracts/schemas/production-order.json), [`plant-department-graph.json`](../contracts/schemas/plant-department-graph.json), prescription `tradeoff`  
