...
7. `external/decisions/020-023/ADR-020-l5-mv-claim-governance.md`
...
11. `external/handoff/l6/l6-counterfactual-display-stub.md`
12. `external/handoff/agents/prompts/consumer-platform-prompt.md`
...
- Analyst RAG is **L4**; send explicit removable context envelopes only ([ADR-023](../../../decisions/020-023/ADR-023-l6-ems-and-analyst-context.md)).
- English only through P2 ([ADR-018](../../../decisions/016-020/ADR-018-l4-pilot-execution-knowledge-reasoning.md)).
- Schema changes → PR in stamped-external + semver; run `./external/scripts/contracts/contract-check.sh`.
