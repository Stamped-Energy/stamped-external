...
1. [external/handoff/l2/core/stamped-l2-spec.md](external/handoff/l2/core/stamped-l2-spec.md) — repo charter
2. [external/handoff/l2/ops/stamped-l2-ecosystem-integration.md](external/handoff/l2/ops/stamped-l2-ecosystem-integration.md) — how all repos connect
3. [external/handoff/l2/core/stamped-l2-l1-consumer-contract.md](external/handoff/l2/core/stamped-l2-l1-consumer-contract.md) — POST /v1/ingest/records
4. [external/handoff/l2/core/stamped-l2-database-schema.md](external/handoff/l2/core/stamped-l2-database-schema.md) — six schemas, DDL, RLS
...
- Dedupe keys must match [dedupe_golden.json](external/contracts/fixtures/golden/dedupe_golden.json) — same as connectors-cloud.
...
See [stamped-l2-upstream-context.md](external/handoff/l2/ops/stamped-l2-upstream-context.md).
```
