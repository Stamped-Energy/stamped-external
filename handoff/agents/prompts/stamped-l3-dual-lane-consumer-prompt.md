...
Read (mandatory, in order):
  1. external/decisions/016-020/ADR-015-l3-dual-lane-lab-detections.md
  2. external/decisions/016-020/ADR-016-attribution-shadow-challengers.md
  3. external/technical/layers/l3/L3-attribution-explainability.md
  4. external/technical/layers/l3/L3-intelligence-core.md §3.4 + §9 Lab retention note
  5. external/handoff/l3/stamped-l3-build-order.md
...
D. AUTHORING.md must link to:
     external/technical/layers/l3/L3-attribution-explainability.md
