...
Read (mandatory, in order):
  1. external/decisions/020-023/ADR-020-l5-mv-claim-governance.md
  2. external/contracts/schemas/intelligence/finding.json          # const schema_version 1.1.0
  3. external/contracts/fixtures/intelligence/finding.valid.json
  4. external/technical/layers/l3/L3-intelligence-core.md §1.1 #3, §2.2, §3.9, §10
  5. external/technical/layers/l4-l6/L5-closure-and-verification.md  (ops-first overview only)
  6. external/handoff/l3/stamped-l3-build-order.md
...
E. Tests: fixture validates against external/contracts/schemas/intelligence/finding.json;
...
- [ ] ./scripts/contracts/contract-check.sh green on pinned external (Finding 1.1.0 fixture)
...
| Check | Path |
|-------|------|
| Schema | [`contracts/schemas/intelligence/finding.json`](../../../contracts/schemas/intelligence/finding.json) |
| Golden | [`contracts/fixtures/intelligence/finding.valid.json`](../../../contracts/fixtures/intelligence/finding.valid.json) |
...
| L5 consumes | [`handoff/l5/stamped-l5-architecture-handoff.md`](./stamped-l5-architecture-handoff.md) |
