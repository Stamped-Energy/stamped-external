...
Single JSON object: **StampedRecordEnvelope** per [stamped-record-envelope.json](../../../contracts/schemas/envelope/stamped-record-envelope.json).
...
Golden expected hashes: [dedupe_golden.json](../../../contracts/fixtures/golden/dedupe_golden.json).
