...
| Doc | Path |
| --- | --- |
| Charter (this file) | `external/handoff/l2/core/stamped-l2-spec.md` |
| Ecosystem wiring | `external/handoff/l2/ops/stamped-l2-ecosystem-integration.md` |
| L1 consumer API | `external/handoff/l2/core/stamped-l2-l1-consumer-contract.md` |
| Database schema | `external/handoff/l2/core/stamped-l2-database-schema.md` |
| Query API | `external/handoff/l2/core/stamped-l2-query-api-sketch.md` |
| AWS deployment | `external/handoff/l2/ops/stamped-l2-aws-deployment.md` |
| Build order | `external/handoff/l2/core/stamped-l2-build-order.md` |
| Upstream L1 context | `external/handoff/l2/ops/stamped-l2-upstream-context.md` |
| Layer interfaces | `external/architecture/layer-interfaces-l2.md` |
| ADR | `external/decisions/006-010/ADR-009-stamped-l2-repo-charter.md` |
