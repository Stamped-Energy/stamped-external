...
> **Aligned with:** [ADR-008 §4](../../../decisions/006-010/ADR-008-layer-repo-topology-and-interfaces.md), [ADR-009](../../../decisions/006-010/ADR-009-stamped-l2-repo-charter.md), [L2 spec §6](../../../technical/layers/l1-l2/L2-universal-repository.md)  
...
- Golden dedupe keys match [dedupe_golden.json](../../../contracts/fixtures/golden/dedupe_golden.json)
...
| --- | --- | --- |
| Contracts | `./scripts/contracts/contract-check.sh` | Schema break |
