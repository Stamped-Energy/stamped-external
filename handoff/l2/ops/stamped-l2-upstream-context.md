...
```bash
./scripts/contracts/contract-check.sh   # jsonschema on external/contracts/
```

Dedupe tests must match [dedupe_golden.json](../../../contracts/fixtures/golden/dedupe_golden.json) exactly.
