...
> **Master context:** [Stamped master document](../../../technical/STAMPED_ARCHITECTURE.md)  
> **Topology ADR:** [ADR-008](../../../decisions/006-010/ADR-008-layer-repo-topology-and-interfaces.md)  
> **L2 charter:** [ADR-009](../../../decisions/006-010/ADR-009-stamped-l2-repo-charter.md)  
> **Deployment modes:** [ADR-010](../../../decisions/006-010/ADR-010-deployment-profiles-and-portability.md) · [deployment-profiles.md](./deployment-profiles.md)  
...
Lab shortcut: `packages/connectors-ingest` in edge repo writes MQTT → local Timescale `measurements_raw`. **Valid in `local` mode** ([ADR-010](../../../decisions/006-010/ADR-010-deployment-profiles-and-portability.md)); **deprecated for `cloud` mode** once stamped-l2 joint E2E is green.
...
| --- | --- | --- |
| `StampedRecordEnvelope` | `external/contracts/schemas/envelope/stamped-record-envelope.json` | Ingest validates inbound |
...
| Dedupe golden | `external/contracts/fixtures/golden/dedupe_golden.json` | CI must match connectors-cloud hashes |
