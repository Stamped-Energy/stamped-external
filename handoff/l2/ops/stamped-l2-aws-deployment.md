...
> **Scope:** **`cloud` deployment mode only** — see [ADR-010](../../../decisions/006-010/ADR-010-deployment-profiles-and-portability.md) for `local` / `local-dashboard` compose profiles.  
> **Budget context:** [ADR-002](../../../decisions/001-005/ADR-002-build-all-aws-networking.md) targets **≤ ₹15–25k/month** total AWS at ≤10 pilot plants. L2 is one slice (~₹3–4.5k).  
> **Charter:** [ADR-009](../../../decisions/006-010/ADR-009-stamped-l2-repo-charter.md)
...
| Region | **ap-south-1** (Mumbai) | [ADR-004](../../../decisions/001-005/ADR-004-compliance-driven-architecture.md) residency |
