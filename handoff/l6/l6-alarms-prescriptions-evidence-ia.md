...
> **Authority conflict:** Platform [ADR-023](../../decisions/020-023/ADR-023-l6-ems-and-analyst-context.md) puts Evidence in primary nav; L6 consumer `DESIGN.md` / DEC-012 treat Evidence as deep-link / Reports-tier. This doc proposes how to resolve that for UX.
