...
> **Authority:** [ADR-024](../decisions/ADR-024-holistic-plant-decisions.md) · [ADR-023](../decisions/ADR-023-l6-ems-and-analyst-context.md) · [`prescription-revision.json`](../contracts/schemas/prescription-revision.json) · [`improvement-signal.json`](../contracts/schemas/improvement-signal.json)  
