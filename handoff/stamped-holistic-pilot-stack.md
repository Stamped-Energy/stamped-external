...
> **Authority:** [ADR-024](../decisions/ADR-024-holistic-plant-decisions.md) · [ADR-025](../decisions/ADR-025-improve-loop-step-06.md) · [REPOS.md](../REPOS.md) · [deployment-profiles.md](./deployment-profiles.md)  
...
- [ ] `external/scripts/contract-check.sh` green
- [ ] Deployment profile chosen: `local-dashboard` or `cloud` ([ADR-010](../decisions/ADR-010-deployment-profiles-and-portability.md))
...
7. Shadow mode ≥2 weeks before WhatsApp on ([02-technical-architecture §17.2](../technical/02-technical-architecture.md))
