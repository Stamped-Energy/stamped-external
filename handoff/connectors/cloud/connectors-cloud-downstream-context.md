...
Single JSON object per message matching [bill-line.json](../../../contracts/schemas/telemetry/bill-line.json).

Reference fixture: [bill_line.valid.json](../../../contracts/fixtures/telemetry/bill_line.valid.json)
...
|---------|---------------------|
| [bill_line.valid.json](../../../contracts/fixtures/telemetry/bill_line.valid.json) | `sha256:2f855d00860753dc937837391d669e5bfd5ff7344f0ea9b788c9584205792dbb` |
...
mosquitto_pub -h 127.0.0.1 -p 1883 -q 1 \
  ...
  -m "$(cat external/contracts/fixtures/telemetry/bill_line.valid.json)"
...
Schema: [event.json](../../../contracts/schemas/envelope/event.json). Cloud maps to `record_type=event`.
