...
> - ADRs: [012](../../../decisions/011-015/ADR-012-l3-artifact-repo-topology.md) · [013](../../../decisions/011-015/ADR-013-counterfactual-savings-ledger.md) · [014](../../../decisions/011-015/ADR-014-ts-foundation-model-role.md) · [014 promotion](../../../decisions/011-015/ADR-014-promotion-record.md)
...
**Answer:** Shadows must ask the same question (which asset/event?). Ablations + STUMPY do. SHAP explains model features; full NILM floods Lab before Path A meters exist ([ADR-016](../../../decisions/016-020/ADR-016-attribution-shadow-challengers.md)).
