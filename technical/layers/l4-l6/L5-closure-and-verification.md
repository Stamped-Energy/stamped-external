...
*Authoritative architecture · July 2026 (ops-first revision 2026-07-21). Companion: [technical architecture](../../STAMPED_ARCHITECTURE.md) §11 · ADRs [019](../../../decisions/016-020/ADR-019-l5-runtime-and-consistency.md) · [020](../../../decisions/020-023/ADR-020-l5-mv-claim-governance.md) · [021](../../../decisions/020-023/ADR-021-l5-notification-and-evidence.md) · [013](../../../decisions/011-015/ADR-013-counterfactual-savings-ledger.md). Handoff: [stamped-l5-architecture-handoff.md](../../../handoff/l5/stamped-l5-architecture-handoff.md). L3 clearance emit: [stamped-l3-ops-clearance-consumer-prompt.md](../../../handoff/agents/prompts/stamped-l3-ops-clearance-consumer-prompt.md).*
...
| 3 | [stamped-l5-architecture-handoff.md](../../../handoff/l5/stamped-l5-architecture-handoff.md) | Implementation authority for `stamped-l5` agents |
| 4 | [02-technical-architecture.md](../../STAMPED_ARCHITECTURE.md) §11 | Stack summary (must not contradict this doc) |
...
Schema: [`contracts/schemas/intelligence/prescription.json`](../../../contracts/schemas/intelligence/prescription.json).
...
*ADR-013.* Cron in L5 worker: delay cost with `verification_status=modeled`; L6 disclaimer ([handoff stub](../../../handoff/l6/l6-counterfactual-display-stub.md)).
