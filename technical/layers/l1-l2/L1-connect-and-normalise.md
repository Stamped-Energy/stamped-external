...
> **Siblings:** [L0 — Plant systems](../02-technical-architecture.md#6-layer-0--plant-systems) · [L2 — Universal Repository](L2-universal-repository.md) · [Technical architecture](../../STAMPED_ARCHITECTURE.md) · [Master doc](../../STAMPED_ARCHITECTURE.md)
...
| Waste category (from [technical architecture](../../STAMPED_ARCHITECTURE.md) §3.1) | Bill impact `[~]` | Minimum L1 stream required |
|---|---|---|
...
From the [technical architecture](../../STAMPED_ARCHITECTURE.md) §4.1 source inventory, restated as ingestion contracts:
...
Refinements over the v1 sketch in the [technical architecture](../../STAMPED_ARCHITECTURE.md) §5.2 — additions marked ★:
...
Pipeline (maps to ML-09 in the [technical architecture](../../STAMPED_ARCHITECTURE.md) §12):
