...
| 3d | [ADR-024](../decisions/ADR-024-holistic-plant-decisions.md) · [ADR-025](../decisions/ADR-025-improve-loop-step-06.md) · [ADR-026](../decisions/ADR-026-two-pillars-shared-context.md) | Holistic shared context + Improve loop + **framing lock** (two pillars only) |
