...
| **Related** | [ADR-002](../001-005/ADR-002-build-all-aws-networking.md) · [ADR-008](ADR-008-layer-repo-topology-and-interfaces.md) · Research brief (`docs/research/enterprise-air-gap-ai-deployment.md` in consumer repos) · [deployment-profiles.md](../../handoff/deployment/deployment-profiles.md) |

---

## Context

Stamped was architected AWS-first ([ADR-002](../001-005/ADR-002-build-all-aws-networking.md), [ADR-009](ADR-009-stamped-l2-repo-charter.md)). Enterprise customers and OT-security plants require the **same product** to run:
...
- `external/handoff/l2/ops/stamped-l2-upstream-context.md` must reclassify `connectors-ingest`
...
- Platform docs distributed via **stamped-platform** submodule ([ADR-011](../011-015/ADR-011-stamped-platform-submodule-distribution.md))
