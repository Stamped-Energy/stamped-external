...
| **Related** | [ADR-001](../001-005/ADR-001-l1-repo-split-and-boundaries.md) · [ADR-003](../001-005/ADR-003-connectors-edge-monorepo.md) · [ADR-008](ADR-008-layer-repo-topology-and-interfaces.md) · [Handoff spec](../../handoff/connectors/cloud/connectors-cloud-downstream-context.md) |
...
**P0 orchestration:** Docker Compose only — no K3s. Playbook: [connectors-cloud-portability-playbook.md](../../handoff/connectors/cloud/connectors-cloud-portability-playbook.md).
