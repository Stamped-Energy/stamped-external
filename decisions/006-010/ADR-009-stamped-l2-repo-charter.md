...
| **Related** | [ADR-008](ADR-008-layer-repo-topology-and-interfaces.md) · [ADR-002](../001-005/ADR-002-build-all-aws-networking.md) · [L2 spec](../../technical/layers/l1-l2/L2-universal-repository.md) · [Handoff spec](../../handoff/l2/core/stamped-l2-spec.md) |
...
| 9 | Cost ceiling | L2 slice **~₹3–4.5k/month** at P0 — see [AWS deployment handoff](../../handoff/l2/ops/stamped-l2-aws-deployment.md) |
...
Research authority: [L2-universal-repository.md](../../technical/layers/l1-l2/L2-universal-repository.md).

---

## 3. Cost-first AWS (P0)

Align with [ADR-002](../001-005/ADR-002-build-all-aws-networking.md) total AWS budget **≤ ₹15–25k/month** at ≤10 pilot plants.
...
Full sizing table: [stamped-l2-aws-deployment.md](../../handoff/l2/ops/stamped-l2-aws-deployment.md).
...
Contract: [stamped-l2-l1-consumer-contract.md](../../handoff/l2/core/stamped-l2-l1-consumer-contract.md).
...
Build order: [stamped-l2-build-order.md](../../handoff/l2/core/stamped-l2-build-order.md).
...
- Next workspace adds **stamped-platform** submodule at `external/` and bootstraps `stamped-l2` repo ([ADR-011](../011-015/ADR-011-stamped-platform-submodule-distribution.md)).
...
Playbook: [stamped-l2-portability-playbook.md](../../handoff/l2/ops/stamped-l2-portability-playbook.md).
