...
| [ADR-004](001-005/ADR-004-compliance-driven-architecture.md) | Compliance-driven architecture | Accepted | `001-005/` |
| [ADR-005](001-005/ADR-005-edge-agent-go-architecture.md) | Go edge-agent architecture | Accepted | `001-005/` |
| [ADR-006](006-010/ADR-006-fleet-ota-substrate.md) | Fleet OTA substrate | Accepted | `006-010/` |
...
| [ADR-016](016-020/ADR-016-attribution-shadow-challengers.md) | Attribution shadow challengers | Accepted | `016-020/` |
| [ADR-017](016-020/ADR-017-l4-adaptive-retrieval-and-web-trust.md) | L4 adaptive RAG + web trust | Accepted | `016-020/` |
| [ADR-018](016-020/ADR-018-l4-pilot-execution-knowledge-reasoning.md) | L4 pilot execution | Accepted | `016-020/` |
...
| [ADR-029](028-032/ADR-029-manual-perception-pipeline.md) | Manual perception pipeline, compile attempts, credibility, prompt cache | Accepted | `028-032/` |

Also: [asset-id-migration.md](024-026/asset-id-migration.md)

Compliance: [../compliance/india-compliance-register.md](../compliance/india-compliance-register.md)  
