...
| **Related** | [ADR-008](../006-010/ADR-008-layer-repo-topology-and-interfaces.md) · [ADR-001](../001-005/ADR-001-l1-repo-split-and-boundaries.md) · [IMPLEMENTATION_PLAN.md](../IMPLEMENTATION_PLAN.md) |

---

## Context

ADR-008 maps one deployable repo per layer (`stamped-l3` → Finding). The L3/L4 intelligence plan requires **semver rulepacks**, **golden eval corpora**, and an **engine runtime** with independent release cadences — similar to how L1 splits into edge/cloud/bill ([ADR-001](../001-005/ADR-001-l1-repo-split-and-boundaries.md)).
