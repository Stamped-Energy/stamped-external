...
| **Related** | [ADR-001](../001-005/ADR-001-l1-repo-split-and-boundaries.md) · [ADR-008](../006-010/ADR-008-layer-repo-topology-and-interfaces.md) · [ADR-010](../006-010/ADR-010-deployment-profiles-and-portability.md) · [SUBMODULE.md](../SUBMODULE.md) |
...
| 6 | CI | Each consumer runs `external/scripts/contracts/contract-check.sh` on PR |
