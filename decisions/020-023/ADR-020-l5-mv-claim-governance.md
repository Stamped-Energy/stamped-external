...
| **Related** | [L5 SSOT](../../technical/layers/l4-l6/L5-closure-and-verification.md) · [ADR-013](../011-015/ADR-013-counterfactual-savings-ledger.md) · [ADR-019](../016-020/ADR-019-l5-runtime-and-consistency.md) · [finding.json](../../contracts/schemas/intelligence/finding.json) · [ledger-entry.json](../../contracts/schemas/closure/ledger-entry.json) |
...
- L3 must emit Finding 1.1.0 `ops_clearance` (+ optional `alarm_hint`) — see [stamped-l3-ops-clearance-consumer-prompt.md](../../handoff/agents/prompts/stamped-l3-ops-clearance-consumer-prompt.md).
