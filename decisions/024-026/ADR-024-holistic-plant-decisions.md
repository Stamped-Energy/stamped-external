...
Distinct from read-only Analyst ([ADR-023](../020-023/ADR-023-l6-ems-and-analyst-context.md)):
...
| Direct SAP write-back for Rx | Indian ERP reality; webhook/CSV sufficient ([L6](../../technical/layers/l4-l6/L6-experience-and-integration.md)) |
