...
| Handoff | [handoff/l5/stamped-l5-architecture-handoff.md](handoff/l5/stamped-l5-architecture-handoff.md) · [build plan](handoff/l5/stamped-l5-build-plan.md) |
...
| Contracts | **0.8.0** |
| L3 paste prompt | [handoff/agents/prompts/stamped-l3-ops-clearance-consumer-prompt.md](handoff/agents/prompts/stamped-l3-ops-clearance-consumer-prompt.md) |

## L6 architecture + UI (2026-07-21)

| Topic | Choice |
|-------|--------|
| Repo | Separate `stamped-l6` modular monolith — web + BFF + worker ([ADR-022](decisions/020-023/ADR-022-l6-bff-runtime-boundary.md)) |
...
| Analyst | Dual-mode: P0 contextual side + P1 full `/analyst`; explicit removable context envelope ([ADR-023](decisions/020-023/ADR-023-l6-ems-and-analyst-context.md)) |
...
| Handoff | [handoff/l6/stamped-l6-architecture-handoff.md](handoff/l6/stamped-l6-architecture-handoff.md) · [UI charter](handoff/l6/stamped-l6-ui-ux-charter.md) · [build plan](handoff/l6/stamped-l6-build-plan.md) |
...
| Full write-up | [handoff/l6/l6-alarms-prescriptions-evidence-ia.md](handoff/l6/l6-alarms-prescriptions-evidence-ia.md) |
...
| Retrieval | Adaptive hybrid H/G/V + allowlisted web T4 — [ADR-017](decisions/016-020/ADR-017-l4-adaptive-retrieval-and-web-trust.md) |
...
**Decision:** Do not promote TimesFM — remain shadow-only. See [ADR-014-promotion-record.md](decisions/011-015/ADR-014-promotion-record.md).
