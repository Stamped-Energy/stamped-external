...
| **Authority docs** | [L3](technical/layers/l3/L3-intelligence-core.md) · [L4](technical/layers/l4-l6/L4-knowledge-and-reasoning.md) · [L5](technical/layers/l4-l6/L5-closure-and-verification.md) · [ADR-008](decisions/006-010/ADR-008-layer-repo-topology-and-interfaces.md) · [layer-interfaces-l2](architecture/layer-interfaces-l2.md) · [L2 query API sketch](handoff/l2/core/stamped-l2-query-api-sketch.md) |
...
- [handoff/l3/stamped-l3-build-order.md](handoff/l3/stamped-l3-build-order.md) + [handoff/l4/stamped-l4-architecture-handoff.md](handoff/l4/stamped-l4-architecture-handoff.md)
...
- Full industrial NILM at incomer ([L3 §3.4](technical/layers/l3/L3-intelligence-core.md))
...
|----------|------|------|-------------|
| L3 spec | [technical/layers/l3/L3-intelligence-core.md](technical/layers/l3/L3-intelligence-core.md) | Engine authority | WS-1 lead |
| L4 spec | [technical/layers/l4-l6/L4-knowledge-and-reasoning.md](technical/layers/l4-l6/L4-knowledge-and-reasoning.md) | Agent authority | WS-1 lead |
| L5 spec | [technical/layers/l4-l6/L5-closure-and-verification.md](technical/layers/l4-l6/L5-closure-and-verification.md) | Ledger authority | WS-1 lead |
...
| L2 query sketch | [handoff/l2/core/stamped-l2-query-api-sketch.md](handoff/l2/core/stamped-l2-query-api-sketch.md) | L3/L4 tool boundary | Read-only |
...
|----------|---------------|------|
| L3 → L2 | `X-Service-Key` + `X-Org-Id` ([query API sketch](handoff/l2/core/stamped-l2-query-api-sketch.md)) | Read-only; no `L2_DATABASE_URL` in L3 |
| L3 → L4 | Outbox + `StampedRecordEnvelope` | At-least-once; idempotent `dedupe_key` |
| L4 → L2 tools | Same service key; HTTP only | **No direct DB** ([ADR-008 §8](decisions/006-010/ADR-008-layer-repo-topology-and-interfaces.md)) |
...
- **Paths (read):** `handoff/stamped-l2-*.md`, `contracts/`, `technical/STAMPED_ARCHITECTURE.md`
...
| **A** | Specs, ADRs, contracts | WS-1 | 18–22 | `./scripts/contracts/contract-check.sh` |
...
| **N** | Validation + hardening | all | 6–8 | `./scripts/contracts/validate.sh` |
...
| # | WS | Commit | Gate |
|---|-----|--------|------|
| 63 | all | `chore: add scripts/contracts/validate.sh orchestrator` | run |
...
|------|-------|---------|---------|
| Fast | Contract schemas + golden fixtures | every commit 16+ | `./scripts/contracts/contract-check.sh` |
...
| M&V baseline | TOW-P / GBM / TimesFM | **TOW-P of record** | [L3 §3.1h](technical/layers/l3/L3-intelligence-core.md) |
| MD exceedance | LightGBM / LSTM / TimesFM | **LightGBM primary**; TimesFM shadow P2 | [L3 §3.3](technical/layers/l3/L3-intelligence-core.md) |
| Rule engine | GoRules / Drools / Python+YAML | **Python+YAML packs** + GoRules for tariff tables P1 | [L3 §3.5](technical/layers/l3/L3-intelligence-core.md) |
...
Orchestrator: `scripts/contracts/validate.sh` (Phase N commit 63).
