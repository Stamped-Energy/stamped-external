# Public website copy snapshot

Excerpt of homepage, solutions hub, both solution pillars, and About from Main_Website `docs/website-copy.md` (19 August 2026). Rupee compounds already use the word **rupee**. Amounts keep the rupee symbol.

**Live SSOT:** Main_Website `lib/content/`. When those pages change, update this file.

Not included: platform, industries, contact, case studies. Those are not the origin/problem/solution canon.
