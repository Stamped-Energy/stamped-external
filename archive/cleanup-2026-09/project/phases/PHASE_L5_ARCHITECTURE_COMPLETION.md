...
| Area | Paths |
|------|-------|
| SSOT | `technical/layers/l4-l6/L5-closure-and-verification.md` |
| ADRs | `decisions/ADR-019*.md`, `ADR-020*.md`, `ADR-021*.md`, `decisions/README.md`, `DECISIONS.md` |
| Contracts | `contracts/schemas/*`, `fixtures/workflow_event.valid.json`, `CHANGELOG.md`, `scripts/contracts/contract-check.sh`, `scripts/contracts/e2e_finding_to_ledger.py` |
| Handoff | `handoff/l5/stamped-l5-architecture-handoff.md`, `stamped-l5-build-plan.md`, `README.md`, L2 schema/query, L6 stub |
| Sync | `technical/STAMPED_ARCHITECTURE.md`, `technical/cross-cutting/03-production-engineering.md`, `architecture/layer-interfaces-l2.md`, `REPOS.md`, `PROGRESS.md`, `CHANGELOG.md`, `README.md` |

## Validation

```bash
./scripts/contracts/contract-check.sh   # OK — 14 schemas, 11 fixtures
python3 scripts/contracts/e2e_finding_to_ledger.py  # after deps
```
...
- Create GitHub `stamped-l5` and execute [build plan](handoff/l5/stamped-l5-build-plan.md)
