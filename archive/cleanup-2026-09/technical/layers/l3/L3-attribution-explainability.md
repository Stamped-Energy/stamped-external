...
> Siblings: [L3 intelligence core §3.4](L3-intelligence-core.md) · [Defense brief](L3-decision-defense-brief.md) · [ADR-015](../../../decisions/016-020/ADR-015-l3-dual-lane-lab-detections.md) · [ADR-016](../../../decisions/016-020/ADR-016-attribution-shadow-challengers.md) · Rulepack [`costart_window`](../../consumers/stamped-l3-rulepacks/domain/attribution/1.0.0/rules/costart_window.yaml)
...
- Optional later: LightGBM **MD forecast** introspection — **not** attribution shadow ([ADR-016](../../../decisions/016-020/ADR-016-attribution-shadow-challengers.md)).
...
**Answer:** Runner-ups stay in Lab (`lab_only`). L4 stays precision-first; discovery retained ([ADR-015](../../../decisions/016-020/ADR-015-l3-dual-lane-lab-detections.md)).
