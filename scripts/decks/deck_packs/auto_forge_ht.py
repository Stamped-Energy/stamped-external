...
PACK = {
    ...
    "math": {
        "eyebrow": "Where value usually shows up on forge and HT floors",
        "h2": "What we check first",
        "ledeD": "Two pillars on the same data plane. Energy actions move MD, idle, and tariff lines. Equipment actions catch drift and trips before the line stops. Sample only until live data confirms.",
        "ledeM": "Energy and equipment checks on forge, HT, and die-cast floors.",
        "cards": [
            (
                "Energy · MD / demand",
                [
                    "Press + furnace coincidence",
                    "Quench pumps with forge start",
                    "Contract demand headroom",
                ],
                "Bill line · MD (kVA)",
                "Example: press ramp and SQF preheat in the same MD window",
            ),
            (
                "Energy · process heat / idle",
                [
                    "Furnace hold over breaks",
                    "Empty-batch soak",
                    "Die-cast hold with zero shots",
                ],
                "Bill line · Energy (kWh)",
                "Example: hold load flat through lunch with no charge scheduled",
            ),
            (
                "Energy · air / PF",
                [
                    "Off-shift compressor unload",
                    "Pressure band too high",
                    "PF penalty before more APFC capex",
                ],
                "Bill line · Energy + PF",
                "Example: night air unload with forge and HT dark",
            ),
            (
                "Equipment · utility drift",
                [
                    "Compressor specific-power rise",
                    "Inspect / clean / tune cards",
                    "Between AMC visits",
                ],
            ...
            (
                ...
                [
                    "Quench or circulation start retries",
                    "Abnormal die-cast duty overnight",
                    "Press ramp signature change",
                ],
                "Ops risk · downtime",
                "Example: three start retries on quench pump before a batch",
            ),
        ],
    },
