...
PACK = {
    ...
    "offerLedeD": "Start with one works. Audit the data, run prescriptions on the floor, then go or no-go at Day 90: on verified ₹ and plant fit.",
    "offerLedeM": "One works. Audit → floor → go / no-go at Day 90.",
}
